  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhhZeebeApp.sick.home.createOrEditLabel">
            <Translate contentKey="jhhZeebeApp.sick.home.createOrEditLabel">Create or edit a Sick</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : sickEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="reasonLabel" for="sick-reason">
                  <Translate contentKey="jhhZeebeApp.sick.reason">Reason</Translate>
                </Label>
                <AvField id="sick-reason" type="text" name="reason" />
              </AvGroup>
              <AvGroup>
                <Label id="daysLabel" for="sick-days">
                  <Translate contentKey="jhhZeebeApp.sick.days">Days</Translate>
                </Label>
                <AvField id="sick-days" type="string" className="form-control" name="days" />
              </AvGroup>
              <AvGroup>
                <Label id="jobKeyLabel" for="sick-jobKey">
                  <Translate contentKey="jhhZeebeApp.sick.jobKey">Job Key</Translate>
                </Label>
                <AvField id="sick-jobKey" type="string" className="form-control" name="jobKey" />
              </AvGroup>
              <AvGroup>
                <Label id="auditUserIdLabel" for="sick-auditUserId">
                  <Translate contentKey="jhhZeebeApp.sick.auditUserId">Audit User Id</Translate>
                </Label>
                <AvField id="sick-auditUserId" type="string" className="form-control" name="auditUserId" />
              </AvGroup>
