...
export const Sick = (props: ISickProps) => {
  ...
  return (
    <div>
      <h2 id="sick-heading">
        <Translate contentKey="jhhZeebeApp.sick.home.title">Sicks</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhhZeebeApp.sick.home.createLabel">Create new Sick</Translate>
        </Link>
      </h2>
        ...
        {sickList && sickList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhhZeebeApp.sick.home.notFound">No Sicks found</Translate>
            </div>
          )
        )}
      </div>
