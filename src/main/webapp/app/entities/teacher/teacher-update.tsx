  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhhZeebeApp.teacher.home.createOrEditLabel">
            <Translate contentKey="jhhZeebeApp.teacher.home.createOrEditLabel">Create or edit a Teacher</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : teacherEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="teacher-name">
                  <Translate contentKey="jhhZeebeApp.teacher.name">Name</Translate>
                </Label>
                <AvField id="teacher-name" type="text" name="name" />
              </AvGroup>
              <AvGroup>
                <Label id="ageLabel" for="teacher-age">
                  <Translate contentKey="jhhZeebeApp.teacher.age">Age</Translate>
                </Label>
                <AvField id="teacher-age" type="string" className="form-control" name="age" />
              </AvGroup>
              <AvGroup>
                <Label id="kemuLabel" for="teacher-kemu">
                  <Translate contentKey="jhhZeebeApp.teacher.kemu">Kemu</Translate>
                </Label>
                <AvField id="teacher-kemu" type="text" name="kemu" />
              </AvGroup>
