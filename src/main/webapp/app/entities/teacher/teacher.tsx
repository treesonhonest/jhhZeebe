  ...
  return (
    <div>
      <h2 id="teacher-heading">
        <Translate contentKey="jhhZeebeApp.teacher.home.title">Teachers</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhhZeebeApp.teacher.home.createLabel">Create new Teacher</Translate>
        </Link>
      </h2>
        ...
        {teacherList && teacherList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhhZeebeApp.teacher.home.notFound">No Teachers found</Translate>
            </div>
          )
        )}
      </div>
