  ...
  return (
    <div>
      <h2 id="student-heading">
        <Translate contentKey="jhhZeebeApp.student.home.title">Students</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhhZeebeApp.student.home.createLabel">Create new Student</Translate>
        </Link>
      </h2>
        ...
        {studentList && studentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhhZeebeApp.student.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="jhhZeebeApp.student.age">Age</Translate>
                </th>
                <th>
                  <Translate contentKey="jhhZeebeApp.student.teacher">Teacher</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhhZeebeApp.student.home.notFound">No Students found</Translate>
            </div>
          )
        )}
      </div>
