...
import com.mycompany.myapp.JhhZeebeApp;
import com.mycompany.myapp.domain.Sick;
import com.mycompany.myapp.repository.SickRepository;
 ...
 */
@SpringBootTest(classes = JhhZeebeApp.class)
...
public class SickResourceIT {
    ...
    private static final Long UPDATED_AUDIT_USER_ID = 2L;
    ...
    public static Sick createUpdatedEntity(EntityManager em) {
        Sick sick = new Sick()
            ...
            .auditUserId(UPDATED_AUDIT_USER_ID);
        return sick;
    }
    ...
    public void createSick() throws Exception {
        ...
        assertThat(testSick.getAuditUserId()).isEqualTo(DEFAULT_AUDIT_USER_ID);
    }
    ...
    public void getAllSicks() throws Exception {
        ...
        restSickMockMvc.perform(get("/api/sicks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].auditUserId").value(hasItem(DEFAULT_AUDIT_USER_ID.intValue())));
    }
    ...
    public void getSick() throws Exception {
        ...
        restSickMockMvc.perform(get("/api/sicks/{id}", sick.getId()))
            ...
            .andExpect(jsonPath("$.auditUserId").value(DEFAULT_AUDIT_USER_ID.intValue()));
    }
    @Test
    @Transactional
    ...
    public void updateSick() throws Exception {
        ...
        assertThat(testSick.getAuditUserId()).isEqualTo(UPDATED_AUDIT_USER_ID);
    }
